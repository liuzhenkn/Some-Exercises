...
//button
$(function(){
	$('.link .button0').hover(function(){
		var title=$(this).attr('data');
		$('.tip0 em').text(title);
		$('.tip0').css({'left':285+'px'}).stop(false,true).animate({'top':102,'opacity':1},300);
	},function(){
	$('.tip0').stop().animate({'top':60,'opacity':0},300);
	})
})
$(function(){
	$('.link .button1').hover(function(){
		var title=$(this).attr('data');
		$('.tip1 em').text(title);
		$('.tip1').css({'left':585+'px'}).stop(false,true).animate({'top':102,'opacity':1},300);
	},function(){
	$('.tip1').stop().animate({'top':60,'opacity':0},300);
	})
})
$(function(){
	$('.link .button2').hover(function(){
		var title=$(this).attr('data');
		$('.tip2 em').text(title);
		$('.tip2').css({'left':883+'px'}).stop(false,true).animate({'top':102,'opacity':1},300);
	},function(){
	$('.tip2').stop().animate({'top':60,'opacity':0},300);
	})
})